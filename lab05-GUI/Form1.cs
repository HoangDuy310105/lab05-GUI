...
namespace lab05_GUI
{
    public partial class Form1 : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            var studentToDelete = studentService.findStudent(studentID);
            if (studentToDelete == null)
            {
                MessageBox.Show("Không tìm thấy sinh viên với ID đã chọn!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            // Xác nhận xóa
            var confirmResult = MessageBox.Show($"Bạn có chắc chắn muốn xóa sinh viên {studentToDelete.FullName} không?",
